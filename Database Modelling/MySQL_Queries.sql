...
-- -----------------------------------------------------
-- Table `global_super_store`.`Location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `global_super_store`.`Location` (
...
-- -----------------------------------------------------
-- Table `global_super_store`.`Time`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `global_super_store`.`Time` (
  `TimeID` INT NOT NULL,
  `Year` INT NOT NULL,
  `Month` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `global_super_store`.`Products_`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `global_super_store`.`Products_` (
